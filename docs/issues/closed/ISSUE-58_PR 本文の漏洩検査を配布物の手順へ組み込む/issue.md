...
- ISSUE-55の F34は、spec が「今回の変更で対象の文が消える」側に数えていたが残った。層 2の docstring に、当初の3分岐の設計の経緯を述べる文が残るため。ISSUE-55で [ ] のまま残している
...
ISSUE-55は層 2のマージ前レビューの残り。この Issue の PR で F2・F25・F35・F36・F38・S3を解決した。F34は残った。
