...
[Issue #9](../closed/9_doctor%20が%20APIPA%20アドレスを健全と判定する/issue.md) で doctor の IP チェックが
...
- [Issue #3: VM 引き当ての前段が複数のサブコマンドに逐語で複製されている](../3_VM%20引き当ての前段が複数のサブコマンドに逐語で複製されている/issue.md)
